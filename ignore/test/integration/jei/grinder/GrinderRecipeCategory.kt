...
object GrinderRecipeCategory : IRecipeCategory<GrinderRecipeWrapper> {
    ...
    private val title = Translator.translateToLocal("text.immersivemagneticraft.jei.grinder")
    ...
    override fun setRecipe(recipeLayout: IRecipeLayout, recipeWrapper: GrinderRecipeWrapper, ingredients: IIngredients?) {
