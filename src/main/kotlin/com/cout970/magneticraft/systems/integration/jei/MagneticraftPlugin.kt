...
class MagneticraftPlugin : IModPlugin {
    ...
    companion object {
        ...
        const val CRUSHING_TABLE_ID = "immersivemagneticraft.crushing_table"
        const val SLUICE_BOX_ID = "immersivemagneticraft.sluice_box"
        const val SIEVE_ID = "immersivemagneticraft.sieve"
        const val HYDRAULIC_PRESS_ID = "immersivemagneticraft.hydraulic_press"
    }
...
//        registry.addRecipeClickArea(...) fuck
    ...
    override fun registerCategories(registry: IRecipeCategoryRegistration) {
        ...
        registry.addRecipeCategories(RecipeCategory<CrushingTableRecipeWrapper>(
                ...
                unlocalizedTitle = "text.immersivemagneticraft.jei.crushing_table",
        ...
        registry.addRecipeCategories(RecipeCategory<SluiceBoxRecipeWrapper>(
                ...
                unlocalizedTitle = "text.immersivemagneticraft.jei.sluice_box",
                initFunc = { recipeLayout, recipeWrapper, ing ->
        ...
        registry.addRecipeCategories(RecipeCategory<SieveRecipeWrapper>(
                ...
                unlocalizedTitle = "text.immersivemagneticraft.jei.sieve",
        ...
        registry.addRecipeCategories(RecipeCategory<HydraulicPressRecipeWrapper>(
                ...
                unlocalizedTitle = "text.immersivemagneticraft.jei.hydraulic_press",
                initFunc = { recipeLayout, recipeWrapper, _ ->
                    ...
                    recipeLayout.itemStacks.set(1, recipeWrapper.recipe.output.applyNonEmpty {
                        addTooltip(t("text.immersivemagneticraft.jei.time", recipeWrapper.recipe.duration.toString()))
                    })
                    ...
                    modeItem.addTooltip(t("text.immersivemagneticraft.jei.hydraulic_hammer." +
    ...
    class CrushingTableRecipeWrapper(val recipe: ICrushingTableRecipe) : IRecipeWrapper {
        ...
        override fun drawInfo(minecraft: Minecraft, recipeWidth: Int, recipeHeight: Int, mouseX: Int, mouseY: Int) {
            ...
            val name = when (level) {
                -1 -> t("text.immersivemagneticraft.jei.mining_level.-1")
                0 -> t("text.immersivemagneticraft.jei.mining_level.0")
                1 -> t("text.immersivemagneticraft.jei.mining_level.1")
                2 -> t("text.immersivemagneticraft.jei.mining_level.2")
                3 -> t("text.immersivemagneticraft.jei.mining_level.3")
                4 -> t("text.immersivemagneticraft.jei.mining_level.4")
                else -> t("text.immersivemagneticraft.jei.mining_level.other", level.toString())
            }
    ...
    class SluiceBoxRecipeWrapper(val recipe: ISluiceBoxRecipe) : IRecipeWrapper {
        ...
        override fun drawInfo(minecraft: Minecraft, recipeWidth: Int, recipeHeight: Int, mouseX: Int, mouseY: Int) {
            minecraft.fontRenderer.drawString(t("text.immersivemagneticraft.jei.require_water"), 0, 68, Color.gray.rgb)
        }
    ...
    class SieveRecipeWrapper(val recipe: ISieveRecipe) : IRecipeWrapper {
        ...
        override fun drawInfo(minecraft: Minecraft, recipeWidth: Int, recipeHeight: Int, mouseX: Int, mouseY: Int) {
            minecraft.fontRenderer.drawString(
                    t("text.immersivemagneticraft.jei.time", recipe.duration.toString()),
